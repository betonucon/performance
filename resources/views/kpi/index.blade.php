                            ...
                            <tbody>
                                @foreach(kpi() as $no=>$data)
                                    <tr>
                                        ...
                                        <td>{{$data['satuan']}}</td>
                                        <td>{{cek_capaian($data->rumus_capaian)}}</td>
                                        <td>{{cek_akumulasi($data->rumus_akumulasi)}}</td>
                                        <td>{{$data->updated_at}}</td>
                                        <td><a href="{{url('kpi/edit/'.$data['id'])}}"><span class="btn btn-success btn-sm"><i class="fa fa-pencil"></i></span></a></td>
                                    </tr>
                                @endforeach
                            </tbody>
