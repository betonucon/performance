<html>
    ...
    <body>     
        <div class="cont">
            <center><img src="{{public_path('img/logoks.png')}}" style="width:30%;"><hr style="border:double 4px #000"><h4>LAPORAN CAPAIAN PERIODE {{$tahun}}<br>{{cek_unit($kode)['nama']}}</h4></center>
