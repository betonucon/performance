                ...
                <tbody>
                    ...
                    @foreach(deployment_realisasi_atasan($kode,$tahun) as $no=>$data)
                        ...
                        <tr style="background:{{$color}}">
                            <td style="border-top:solid 0px #fff;border-bottom:solid 0px #fff;">{{$data->kode_kpi}}</td>
                            <td style="border-top:solid 0px #fff;border-bottom:solid 0px #fff;">{{cek_kpi($data->kode_kpi)['kpi']}}</td>
                            <td style="border-top:solid 0px #fff;border-bottom:solid 0px #fff;" style="padding:0px;">{{cek_capaian($data['rumus_capaian'])}}<hr style="margin: 0px;border-color:#b7b7bd">{{cek_akumulasi($data['rumus_akumulasi'])}}</td>
                            <td style="border-top:solid 0px #fff;border-bottom:solid 0px #fff;">{{$data->bobot_tahunan}}</td>
                            <td style="border-top:solid 0px #fff;border-bottom:solid 0px #fff;">{{$data->target_tahunan}}</td>
                            <td style="border-top:solid 0px #fff;border-bottom:solid 0px #fff;">{{cek_kpi($data->kode_kpi)['satuan']}}</td>
                            <td style="border-top:solid 0px #fff;border-bottom:solid 0px #fff;">T</td>
