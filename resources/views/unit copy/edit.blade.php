                            ...
                            <form method="post" id="mydata" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly name="kode_unit" value="{{$data['kode_unit']}}" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Nama Unit</label>
                                        <input type="text" name="nik" onkeyup="cari_nik(this.value)" value="{{cek_unit($data['kode_unit'](['nama']}}" class="form-control">
                                    </div>
                                    <div class="form-group">
